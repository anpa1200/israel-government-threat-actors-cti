...
head:
  - tag: script
    ...
    innerHTML: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is MuddyWater?","acceptedAnswer":{"@type":"Answer","text":"MuddyWater (also known as Seedworm, MERCURY, and Static Kitten) is an Iranian cyber espionage group explicitly designated as a MOIS (Ministry of Intelligence and Security) subordinate element in CISA advisory AA22-055A. Active since approximately 2017, the group targets Israeli government, defense, telecommunications, and critical infrastructure using RMM software abuse, PowerShell-based toolsets, and living-off-the-land techniques."}},{"@type":"Question","name":"How to detect MuddyWater in enterprise environments?","acceptedAnswer":{"@type":"Answer","text":"Key MuddyWater detection approaches: monitor legitimate RMM tools (Atera, ScreenConnect, SimpleHelp) launched from unusual parent processes or outside business hours; detect PowerShell with Base64-encoded command-line arguments establishing outbound connections; watch for schtasks.exe creating scheduled tasks with encoded payloads; monitor LSASS access from non-standard processes for credential dumping; look for phishing documents with macro or template injection targeting government email accounts."}},{"@type":"Question","name":"What tools and malware does MuddyWater use?","acceptedAnswer":{"@type":"Answer","text":"MuddyWater's toolset includes: legitimate RMM software (Atera, ScreenConnect, SimpleHelp) repurposed as C2 channels; PowerShell-based downloaders and custom backdoors including BugSleep and MuddySleep; PhonyC2 framework; Cobalt Strike in some campaigns; and extensive use of living-off-the-land binaries (LOLBins) including msiexec, regsvr32, and certutil. The group favors blending with legitimate IT operations over deploying novel malware."}}]}'
---
