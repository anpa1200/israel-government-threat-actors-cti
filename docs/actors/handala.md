...
head:
  - tag: script
    ...
    innerHTML: '{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What is Handala (Void Manticore)?","acceptedAnswer":{"@type":"Answer","text":"Handala (tracked by Microsoft as Void Manticore) is a MOIS-linked Iranian threat actor that emerged prominently following the October 7, 2023 Hamas attack on Israel. The group operates via the Handala Hack and Karma Telegram personas, combining data theft, wiper deployment, and psychological influence operations against Israeli organizations. Assessed as a MOIS-directed destructive actor with explicit messaging amplified through Telegram channels to maximize psychological impact."}},{"@type":"Question","name":"How to detect Handala or Void Manticore wiper attacks?","acceptedAnswer":{"@type":"Answer","text":"Key detection approaches for Handala/Void Manticore: monitor for BiBi wiper artifacts (files overwritten with random data, extensions replaced with .BiBi suffix); detect high-volume file modification or deletion from unusual processes across multiple directories simultaneously; watch for credential theft activity preceding destructive operations (Handala typically steals data before wiping); monitor Telegram and dark web channels for your organization's data appearing in Handala leak posts."}},{"@type":"Question","name":"What destructive operations has Handala conducted?","acceptedAnswer":{"@type":"Answer","text":"Handala/Void Manticore has targeted Israeli organizations with BiBi wiper malware (named for the Hebrew nickname of Prime Minister Netanyahu), conducting data theft followed by system destruction. The group claims breaches of Israeli government, military-adjacent, technology, and civilian organizations via its Telegram channels, releasing documents and internal data to amplify psychological impact. Operations have continued throughout the 2023-2025 conflict period with increasing frequency."}}]}'
---
