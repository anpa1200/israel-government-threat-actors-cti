...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Python-based implant reported in MuddyWater-linked post-exploitation. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt Python execution from temporary paths, persistence changes, and suspicious outbound sessions. |
