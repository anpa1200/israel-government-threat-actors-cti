...
- Tool type(s): Script / collection tool
...
| --- | --- |
| [APT42](../actors/apt42.md) | PowerShell-based collection tooling referenced for APT42 activity; useful as a behavior anchor for script execution and collection staging. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [APT42](../actors/apt42.md) | Hash not committed; source-linked behavior only. | `SRC-MITRE-G1044` |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT42](../actors/apt42.md) | Hunt PowerShell collection from unusual parent processes, cloud identity follow-on access, and archive staging after phishing. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [APT42](../actors/apt42.md) | Do not store script content or samples. |
