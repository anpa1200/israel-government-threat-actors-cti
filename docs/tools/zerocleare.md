...
- Associated actor(s): [OilRig](../actors/oilrig.md); [Void Manticore / Handala](../actors/handala.md)
- Tool type(s): Wiper
...
| --- | --- |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists ZeroCleare as software used by this actor; track it as raw-disk destructive wipe behavior. |
| [Void Manticore / Handala](../actors/handala.md) | MITRE ATT&CK lists ZeroCleare as software used by this actor; track it as raw-disk destructive wipe behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [OilRig](../actors/oilrig.md) | Hunt for ZeroCleare execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [Void Manticore / Handala](../actors/handala.md) | Hunt for ZeroCleare execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
