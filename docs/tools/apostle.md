...
- Tool type(s): Wiper / ransomware-like malware
...
| --- | --- |
| [Agrius](../actors/agrius.md) | MITRE ATT&CK lists Apostle as software used by this actor; track it as destructive or ransomware-like impact behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Hunt for Apostle execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
