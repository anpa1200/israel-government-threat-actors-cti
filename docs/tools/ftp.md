...
- Associated actor(s): [OilRig](../actors/oilrig.md); [APT39](../actors/apt39.md); [Void Manticore / Handala](../actors/handala.md)
- Tool type(s): Living-off-the-land utility
- Confidence level(s): Medium
- Source ID(s): `SRC-MITRE-G0049`, `SRC-MITRE-G0087`, `SRC-MITRE-G1055`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE ATT&CK lists ftp as software used by this actor; track it as file transfer over FTP. |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists ftp as software used by this actor; track it as file transfer over FTP. |
| [Void Manticore / Handala](../actors/handala.md) | MITRE ATT&CK lists ftp as software used by this actor; track it as file transfer over FTP. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt for ftp execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [OilRig](../actors/oilrig.md) | Hunt for ftp execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [Void Manticore / Handala](../actors/handala.md) | Hunt for ftp execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
