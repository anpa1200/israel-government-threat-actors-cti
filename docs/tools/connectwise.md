...
- Tool type(s): Remote monitoring and management tool
...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists ConnectWise as software used by this actor; track it as remote administration and screen capture behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for ConnectWise execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
