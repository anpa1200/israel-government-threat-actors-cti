...
- Associated actor(s): [Magic Hound](../actors/apt35.md); [Lyceum](../actors/lyceum.md)
- Tool type(s): Network utility
- Confidence level(s): Medium
- Source ID(s): `SRC-MITRE-G0059`, `SRC-MITRE-G1001`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists Ping as software used by this actor; track it as connectivity and remote host discovery. |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists Ping as software used by this actor; track it as connectivity and remote host discovery. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for Ping execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [Magic Hound](../actors/apt35.md) | Hunt for Ping execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
