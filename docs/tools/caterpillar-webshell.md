...
| --- | --- |
| [Lebanese Cedar](../actors/lebanese-cedar.md) | Modified JSP file browser/webshell used by Lebanese Cedar for persistence on public-facing servers. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lebanese Cedar](../actors/lebanese-cedar.md) | Hunt modified JSP files, unexpected upload paths, and web server process spawning shells. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [Lebanese Cedar](../actors/lebanese-cedar.md) | Use behavior and webroot integrity monitoring. |
