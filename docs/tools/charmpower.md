...
- Tool type(s): PowerShell backdoor
...
| --- | --- |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists CharmPower as software used by this actor; track it as PowerShell-based C2 and collection behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Hunt for CharmPower execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
