...
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Mandiant reports TEMPLELOCK as a .NET utility observed in foothold utilities and passive implants, capable of terminating threats associated with Windows Event Log service and restarting service operation on demand. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [UNC1860](../actors/unc1860.md) | Hash not committed; use Mandiant activity-level IOC list. | `SRC-MANDIANT-UNC1860` |
...
| Actor | Hunting Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Hunt Event Log service stop/start anomalies, log service tampering, and unusual .NET utility execution from compromised servers. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Treat as behavior trigger, not attribution by itself. |
