...
- Tool type(s): Living-off-the-land binary
...
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists BITSAdmin as software used by this actor; track it as BITS-based file transfer or job execution behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for BITSAdmin execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
