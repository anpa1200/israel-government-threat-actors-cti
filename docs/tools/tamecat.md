...
APT42-linked backdoor with scripting, encrypted communications, and discovery-oriented behavior in public reporting.
...
Hunt script execution, discovery commands, and encrypted outbound sessions following APT42-themed lure activity.
