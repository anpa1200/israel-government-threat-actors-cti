...
| --- | --- |
| [APT42](../actors/apt42.md) | APT42-linked backdoor with scripting, encrypted communications, and discovery-oriented behavior in public reporting. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT42](../actors/apt42.md) | Hunt script execution, discovery commands, and encrypted outbound sessions following APT42-themed lure activity. |
