...
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists Milan as software used by this actor; track it as Lyceum-linked backdoor behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for Milan execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
