...
- Tool type(s): Referenced tool/family term
...
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Malpedia library links PipeSnoop to the Mandiant UNC1860 Temple of Oats reference set. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [UNC1860](../actors/unc1860.md) | Reference confirmed by Malpedia; no per-sample hash committed in this repo. | `SRC-MALPEDIA-UNC1860` |
...
| Actor | Hunting Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Use as a research pivot term for UNC1860 tooling; require source-backed behavior before detection logic. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Do not overclaim behavior from the name alone. |
