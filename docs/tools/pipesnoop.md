...
- Tool type: Referenced tool/family term
- Confidence: Low
...
Malpedia library links PipeSnoop to the Mandiant UNC1860 Temple of Oats reference set.

## Hash And IOC Status

- Status: Reference confirmed by Malpedia; no per-sample hash committed in this repo.
...
Use as a research pivot term for UNC1860 tooling; require source-backed behavior before detection logic.

## Handling Notes

Do not overclaim behavior from the name alone.
