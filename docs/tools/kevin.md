...
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Lyceum-associated backdoor line referenced by public reporting. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Use as enrichment term for Lyceum hunting until behavior is source-backed locally. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Do not create hash-only production rules. |
