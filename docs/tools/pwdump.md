...
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE ATT&CK lists pwdump as software used by this actor; track it as password hash dumping behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt for pwdump execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
