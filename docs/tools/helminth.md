...
| --- | --- |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists Helminth as software used by this actor; track it as source-backed software use by the actor. |
...
| Actor | Hunting Notes |
| --- | --- |
| [OilRig](../actors/oilrig.md) | Hunt for Helminth execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
