...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists Koadic as software used by this actor; track it as scripted post-exploitation and remote command behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for Koadic execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
