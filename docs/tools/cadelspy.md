...
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE ATT&CK lists Cadelspy as software used by this actor; track it as APT39-linked backdoor behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt for Cadelspy execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
