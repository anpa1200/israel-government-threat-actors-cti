...
sidebar_label: MultiLayer Wiper
---
...
| --- | --- |
| [Agrius](../actors/agrius.md) | MITRE ATT&CK lists MultiLayer Wiper as software used by this actor; track it as multi-stage destructive wiping behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Hunt for MultiLayer Wiper execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
