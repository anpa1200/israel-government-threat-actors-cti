...
- Tool type(s): Process discovery utility
...
| --- | --- |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists Tasklist as software used by this actor; track it as process discovery behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [OilRig](../actors/oilrig.md) | Hunt for Tasklist execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
