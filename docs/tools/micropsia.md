...
| --- | --- |
| [APT-C-23](../actors/arid-viper.md) | MITRE ATT&CK lists Micropsia as software used by this actor; track it as Windows backdoor and collection behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT-C-23](../actors/arid-viper.md) | Hunt for Micropsia execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
