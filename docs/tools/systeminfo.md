...
| --- | --- |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists Systeminfo as software used by this actor; track it as host information discovery. |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists Systeminfo as software used by this actor; track it as host information discovery. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Hunt for Systeminfo execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [OilRig](../actors/oilrig.md) | Hunt for Systeminfo execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
