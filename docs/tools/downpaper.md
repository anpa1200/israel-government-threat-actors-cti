...
| --- | --- |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists DownPaper as software used by this actor; track it as PowerShell/VBS backdoor and discovery behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Hunt for DownPaper execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
