...
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | MITRE ATT&CK lists CHIMNEYSWEEP as software used by this actor; track it as destructive wipe behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | Hunt for CHIMNEYSWEEP execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
