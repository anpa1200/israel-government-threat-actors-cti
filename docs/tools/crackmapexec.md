...
- Associated actor(s): [MuddyWater](../actors/muddywater.md); [APT39](../actors/apt39.md)
...
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE ATT&CK lists CrackMapExec as software used by this actor; track it as network credential validation and lateral movement behavior. |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists CrackMapExec as software used by this actor; track it as network credential validation and lateral movement behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt for CrackMapExec execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [MuddyWater](../actors/muddywater.md) | Hunt for CrackMapExec execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
