...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists Out1 as software used by this actor; track it as source-backed software use by the actor. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for Out1 execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
