...
| --- | --- |
| [APT-C-23](../actors/arid-viper.md) | MITRE ATT&CK lists FrozenCell as software used by this actor; track it as mobile surveillance and collection behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT-C-23](../actors/arid-viper.md) | Hunt for FrozenCell execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
