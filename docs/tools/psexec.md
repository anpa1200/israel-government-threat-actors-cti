...
- Associated actor(s): [OilRig](../actors/oilrig.md); [Magic Hound](../actors/apt35.md); [APT39](../actors/apt39.md)
- Tool type(s): Remote execution utility
- Confidence level(s): Medium
- Source ID(s): `SRC-MITRE-G0049`, `SRC-MITRE-G0059`, `SRC-MITRE-G0087`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE ATT&CK lists PsExec as software used by this actor; track it as service-based lateral execution behavior. |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists PsExec as software used by this actor; track it as service-based lateral execution behavior. |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists PsExec as software used by this actor; track it as service-based lateral execution behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt for PsExec execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [Magic Hound](../actors/apt35.md) | Hunt for PsExec execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [OilRig](../actors/oilrig.md) | Hunt for PsExec execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
