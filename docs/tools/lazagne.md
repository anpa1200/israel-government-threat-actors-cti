...
- Associated actor(s): [OilRig](../actors/oilrig.md); [MuddyWater](../actors/muddywater.md)
- Tool type(s): Credential access tool
- Confidence level(s): Medium
- Source ID(s): `SRC-MITRE-G0049`, `SRC-MITRE-G0069`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists LaZagne as software used by this actor; track it as password-store extraction behavior. |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists LaZagne as software used by this actor; track it as password-store extraction behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for LaZagne execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [OilRig](../actors/oilrig.md) | Hunt for LaZagne execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
