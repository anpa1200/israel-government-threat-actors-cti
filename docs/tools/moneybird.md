...
- Tool type: Ransomware / destructive malware
- Confidence: Medium
...
Agrius-associated ransomware-like payload reported in targeted Israeli incidents; use as destructive-operation context rather than stable criminal-brand attribution.

## Hash And IOC Status

- Status: Hash not committed; source IOC appendix should be used if needed.
...
Prioritize VSS deletion, backup tampering, mass file writes, and pseudo-ransomware staging behavior.
