...
- Tool type(s): Ransomware / destructive malware
...
| --- | --- |
| [Agrius](../actors/agrius.md) | Agrius-associated ransomware-like payload reported in targeted Israeli incidents; use as destructive-operation context rather than stable criminal-brand attribution. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [Agrius](../actors/agrius.md) | Hash not committed; source IOC appendix should be used if needed. | `SRC-MITRE-G1030` |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Prioritize VSS deletion, backup tampering, mass file writes, and pseudo-ransomware staging behavior. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Do not store payloads. |
