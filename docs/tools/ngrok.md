...
| --- | --- |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists ngrok as software used by this actor; track it as external tunnel creation behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [OilRig](../actors/oilrig.md) | Hunt for ngrok execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
