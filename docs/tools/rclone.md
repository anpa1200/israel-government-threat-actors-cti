...
- Tool type(s): Cloud sync / exfiltration utility
...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists Rclone as software used by this actor; track it as cloud-storage synchronization and exfiltration behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for Rclone execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
