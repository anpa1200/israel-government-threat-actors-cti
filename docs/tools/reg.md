...
| --- | --- |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists Reg as software used by this actor; track it as registry query or modification behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [OilRig](../actors/oilrig.md) | Hunt for Reg execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
