...
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Mandiant reports TEMPLEDROP repurposed a legitimate Iranian AV file-system filter driver for protecting deployed files and its own file from modification. |
