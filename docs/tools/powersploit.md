...
- Tool type(s): PowerShell post-exploitation framework
...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists PowerSploit as software used by this actor; track it as PowerShell offensive module execution. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for PowerSploit execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
