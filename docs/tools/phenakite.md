...
| --- | --- |
| [APT-C-23](../actors/arid-viper.md) | MITRE ATT&CK lists Phenakite as software used by this actor; track it as mobile surveillance behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT-C-23](../actors/arid-viper.md) | Hunt for Phenakite execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
