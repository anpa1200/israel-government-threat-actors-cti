...
Lyceum / HEXANE-associated backdoor family referenced in MITRE and public reporting.
...
Hunt telecom and energy endpoint persistence, C2, and lateral movement in MENA-relevant environments.

## Handling Notes

Validate sample-level claims before detection engineering.
