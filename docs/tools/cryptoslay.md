...
- Tool type(s): Associated family
- Confidence level(s): Medium
- Source ID(s): `SRC-MALPEDIA-UNC1860`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Malpedia lists win.cryptoslay as an associated UNC1860 family and ties the reference set to Mandiant's UNC1860 reporting. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [UNC1860](../actors/unc1860.md) | Family confirmed by Malpedia; no per-sample hash committed in this repo. | `SRC-MALPEDIA-UNC1860` |
...
| Actor | Hunting Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Use as taxonomy enrichment; do not create production detections until behavior is tied to a primary source or sample-level report. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Malpedia taxonomy confirms association; behavior remains source-gated. |
...
| --- | --- | --- | --- | --- | --- |
| [`SRC-MALPEDIA-UNC1860`](https://malpedia.caad.fkie.fraunhofer.de/actor/unc1860) | Malpedia | 2026-05-14 | A | Malware knowledge base | 2026-05-14 |
