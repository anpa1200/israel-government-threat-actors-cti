...
sidebar_label: Windows Credential Editor
---
...
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE ATT&CK lists Windows Credential Editor as software used by this actor; track it as Windows credential extraction behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt for Windows Credential Editor execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
