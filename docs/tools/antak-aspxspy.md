...
| --- | --- |
| [APT39](../actors/apt39.md) | MITRE reports APT39 installed ANTAK and ASPXSPY web shells. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [APT39](../actors/apt39.md) | Hash not committed; use source-linked IOCs and local webroot baselines. | `SRC-MITRE-G0087` |
...
| Actor | Hunting Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Hunt webroot integrity changes, web server child processes, and suspicious ASPX/JSP server-side files. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [APT39](../actors/apt39.md) | Do not treat common webshell names as attribution alone. |
