...
- Tool type(s): Dual-use tunneling / proxy tooling
...
| --- | --- |
| [Magic Hound](../actors/apt35.md) | MITRE reports Magic Hound use of Fast Reverse Proxy and Plink-style tooling for proxying, masqueraded access, and non-standard C2 routing. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [Magic Hound](../actors/apt35.md) | No malware hash; dual-use binary monitoring and local allowlisting required. | `SRC-MITRE-G0059` |
...
| Actor | Hunting Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Hunt FRP/Plink execution from user paths or server paths, masqueraded filenames, non-standard ports, and unauthorized proxy sessions. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Dual-use; tool presence alone is not attribution. |
