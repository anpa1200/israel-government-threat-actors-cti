...
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists PoshC2 as software used by this actor; track it as PowerShell/C2 framework behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for PoshC2 execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
