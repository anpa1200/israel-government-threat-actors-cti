...
| --- | --- |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists certutil as software used by this actor; track it as download, decode, and certificate-store abuse behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [OilRig](../actors/oilrig.md) | Hunt for certutil execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
