...
| --- | --- |
| [Agrius](../actors/agrius.md) | MITRE ATT&CK lists IPsec Helper as software used by this actor; track it as source-backed software use by the actor. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Hunt for IPsec Helper execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
