...
| --- | --- |
| [Agrius](../actors/agrius.md) | MITRE ATT&CK lists DEADWOOD as software used by this actor; track it as destructive wipe behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Hunt for DEADWOOD execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
