...
| --- | --- |
| [Agrius](../actors/agrius.md) | MITRE ATT&CK lists ASPXSpy as software used by this actor; track it as server-side web shell persistence. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Hunt for ASPXSpy execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
