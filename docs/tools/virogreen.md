...
- Tool type: GUI exploitation / post-exploitation framework
- Confidence: High
...
Mandiant reports VIROGREEN as a custom framework for scanning and exploiting CVE-2019-0604 SharePoint servers and controlling payloads, backdoors, STAYSHANTE, BASEWALK, command execution, upload, and download.

## Hash And IOC Status

- Status: Hash not committed; use Mandiant source and technical annex where accessible.
...
Hunt SharePoint exploitation, unexpected files under SharePoint paths, and post-exploitation command/upload/download behavior.

## Handling Notes

Do not reproduce exploit workflow.
