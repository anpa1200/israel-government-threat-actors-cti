...
| --- | --- |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists PowerLess as software used by this actor; track it as Magic Hound-linked backdoor behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Hunt for PowerLess execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
