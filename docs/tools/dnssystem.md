...
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists DnsSystem as software used by this actor; track it as Lyceum-linked DNS/C2 backdoor behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for DnsSystem execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
