...
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | MITRE ATT&CK lists RawDisk as software used by this actor; track it as raw disk access for destructive operations. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | Hunt for RawDisk execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
