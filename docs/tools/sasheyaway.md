...
- Tool type(s): Dropper / access-enablement tooling
...
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Mandiant reports SASHEYAWAY as a low-detection dropper that can enable execution of full passive backdoors such as TEMPLEDOOR, FACEFACE, and SPARKLOAD. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [UNC1860](../actors/unc1860.md) | Mandiant publishes activity-level MD5 IOCs and a VT collection; this repo does not map every hash to SASHEYAWAY. | `SRC-MANDIANT-UNC1860` |
...
| Actor | Hunting Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Hunt dropper-to-passive-backdoor chains, low-prevalence .NET utilities, and follow-on deployment from exploited public-facing servers. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [UNC1860](../actors/unc1860.md) | Use behavior plus multiple evidence lines. |
