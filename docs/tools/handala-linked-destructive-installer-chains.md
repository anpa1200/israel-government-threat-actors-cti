...
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | Archive or installer-centered destructive chains used as defensive first-30-minutes response model. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | Hash not committed; chain behavior matters more than static IOCs. | `SRC-AP-HANDALA` |
...
| Actor | Hunting Notes |
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | Hunt archive extraction, suspicious installer execution, mass process creation, and rapid destructive staging. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [Void Manticore / Handala](../actors/handala.md) | Validate against original technical references. |
