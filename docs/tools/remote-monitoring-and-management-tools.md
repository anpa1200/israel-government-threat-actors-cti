...
- Tool type(s): Living-off-the-land tooling
...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Legitimate remote-management software abused for access, persistence, and operator control in MuddyWater-linked intrusion chains. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [MuddyWater](../actors/muddywater.md) | No malware hash; inventory and signed binary allowlist required. | `SRC-MITRE-G0069` |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Compare RMM binaries, installation paths, remote URLs, and parents against approved enterprise inventory. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Dual-use tooling; avoid actor attribution from tool presence alone. |
