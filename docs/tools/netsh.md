...
- Tool type(s): Network configuration utility
...
| --- | --- |
| [Magic Hound](../actors/apt35.md) | MITRE ATT&CK lists netsh as software used by this actor; track it as network configuration or firewall manipulation. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Magic Hound](../actors/apt35.md) | Hunt for netsh execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
