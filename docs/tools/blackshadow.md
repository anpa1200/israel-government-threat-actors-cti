...
- Tool type(s): Ransomware / persona
...
| --- | --- |
| [Agrius](../actors/agrius.md) | Agrius-linked destructive/extortion persona and malware reference depending on source context. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [Agrius](../actors/agrius.md) | Hash not committed; persona claims require corroboration. | `SRC-MITRE-G1030` |
...
| Actor | Hunting Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Separate public claims from telemetry; hunt destructive preparation and data theft before leak publication. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [Agrius](../actors/agrius.md) | Treat persona claims through the persona-claims register. |
