...
- Tool type(s): Remote administration tool
...
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists RemoteUtilities as software used by this actor; track it as remote access and operator control behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt for RemoteUtilities execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
