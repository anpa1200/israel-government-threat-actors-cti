...
- Source ID(s): `SRC-THREAT-HUNTER-V3`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Deno runtime-based implant reported in MuddyWater-linked activity. |

## Hash And IOC Status

| Actor | Status | Reference |
| --- | --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hash not committed; use source-linked IOCs only. | `SRC-THREAT-HUNTER-V3` |
...
| Actor | Hunting Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Hunt unusual Deno runtime execution, user-path staging, and network egress not tied to development hosts. |

## Handling Notes

| Actor | Handling Notes |
| --- | --- |
| [MuddyWater](../actors/muddywater.md) | Supporting source; promote only after primary-source validation. |
...
| --- | --- | --- | --- | --- | --- |
| [`SRC-THREAT-HUNTER-V3`](https://www.threathunter.ai/blog/stryker-handala-mois-muddywater-unified-brief-detection-pack-v3) | ThreatHunter.ai | 2026-04-16 | B | Vendor CTI | 2026-05-14 |
