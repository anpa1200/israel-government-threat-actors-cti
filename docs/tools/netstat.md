...
- Associated actor(s): [OilRig](../actors/oilrig.md); [Lyceum](../actors/lyceum.md)
- Tool type(s): System discovery utility
- Confidence level(s): Medium
- Source ID(s): `SRC-MITRE-G0049`, `SRC-MITRE-G1001`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists netstat as software used by this actor; track it as network connection discovery. |
| [OilRig](../actors/oilrig.md) | MITRE ATT&CK lists netstat as software used by this actor; track it as network connection discovery. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for netstat execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [OilRig](../actors/oilrig.md) | Hunt for netstat execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
