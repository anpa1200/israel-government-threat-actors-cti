...
- Associated actor(s): [MuddyWater](../actors/muddywater.md); [Lyceum](../actors/lyceum.md)
- Tool type(s): Post-exploitation framework
- Confidence level(s): Medium
- Source ID(s): `SRC-MITRE-G0069`, `SRC-MITRE-G1001`

## Behavior

| Actor | Behavior Summary |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | MITRE ATT&CK lists Empire as software used by this actor; track it as PowerShell-based post-exploitation behavior. |
| [MuddyWater](../actors/muddywater.md) | MITRE ATT&CK lists Empire as software used by this actor; track it as PowerShell-based post-exploitation behavior. |
...
| Actor | Hunting Notes |
| --- | --- |
| [Lyceum](../actors/lyceum.md) | Hunt for Empire execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
| [MuddyWater](../actors/muddywater.md) | Hunt for Empire execution or artifacts only in context: unusual parent process, unexpected host role, suspicious account, external staging, or proximity to the actor intrusion chain. |
