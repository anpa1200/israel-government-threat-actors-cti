...
- Optional VirusTotal malware-hash enrichment workflow:
  [../virustotal-enrichment.md](../virustotal-enrichment.md).
...
- VirusTotal MAY be used for enrichment, but verdict labels MUST NOT be used as
  actor attribution and raw VT JSON or samples MUST NOT be committed.
