...
- [CTI Analyst Field Manual — Source Reliability](https://1200km.com/cti-analyst-field-manual/docs/cti-foundations/source-reliability/) — full Admiralty Code tables with A-F and 1-6 calibration
- [CTI Analyst Field Manual — Confidence Language](https://1200km.com/cti-analyst-field-manual/docs/cti-foundations/confidence-language/) — High/Medium/Low criteria with evidence quality examples
- [CTI Analyst Field Manual — Detection Readiness Levels](https://1200km.com/cti-analyst-field-manual/docs/cti-to-detection/detection-readiness-levels/) — DRL scale with validation artifacts and DRL-9 evidence pack requirements
