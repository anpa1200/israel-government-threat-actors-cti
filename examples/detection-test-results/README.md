...
| `DET-002` | `synthetic-fixtures.json`, `synthetic-test-summary.md` | Synthetic 30-day replay substitute with 240 benign events, two seeded malicious events, and false-positive measurement. |
